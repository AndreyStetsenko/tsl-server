const countries = [
    ...
    { id: "CF", name: "Central African", name2: "Central African Republic" },
    { id: "TD", name: "Chad" },
    { id: "CL", name: "Chile" },
    { id: "CN", name: "China" },
    ...
    { id: "CI", name: "Côte d'Ivoire", name2: "Cote D'Ivoire" },
    { id: "HR", name: "Croatia" },
    { id: "CU", name: "Cuba" },
    { id: "CY", name: "Cyprus" },
    ...
    { id: "EE", name: "Estonia" },
    { id: "ET", name: "Ethiopia" },
    { id: "FK", name: "Falkland Islands", name2: "Falkland Islands (Malvinas)" },
    ...
    { id: "NO", name: "Norway" },
    { id: "PS", name: "Occupied Palestinian Territory" },
    { id: "OM", name: "Oman" },
    { id: "PK", name: "Pakistan" },
    { id: "PW", name: "Palau" },
    { id: "PA", name: "Panama" },
    ...
    { id: "MD", name: "Republic of Moldova", name2: "Moldova" },
    { id: "CG", name: "Republic of the Congo" },
    { id: "RE", name: "Réunion" },
    { id: "RO", name: "Romania" },
    { id: "RU", name: "Russian Federation", name2: "Russia" },
    { id: "RW", name: "Rwanda" },
